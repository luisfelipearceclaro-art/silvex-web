<?php
$portfolioCases = array_values(array_filter(
    require __DIR__ . "/data/portfolio.php",
    function ($case) {
        return ($case["visible"] ?? true) !== false;
    }
));
...
?>
    ...
    <section class="portfolio-grid">
      <?php if (empty($portfolioCases)): ?>
        <article class="portfolio-card">
          <div class="portfolio-card__content">
            <h3>Portafolio en actualizacion</h3>
            <p>Muy pronto mostraremos nuevos casos de exito aqui.</p>
          </div>
        </article>
      <?php else: ?>
